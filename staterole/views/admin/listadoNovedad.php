...
?>
  ...
  <div class="container-fluid" style="background-color: #fff; padding: 70px; ">
      ...
      foreach ($res as $x) {
        ...
        echo "
          ...
          <td align=center>";
            ...
            if ($x["estado_novedad"]==2) {
              echo "
              <form action='../pdf/$x[id_tipo_novedad].php' method='post'>
              <input type='hidden' name='id_usuario' value=".$x["id_usuario"].">
              <button class='btn fa fa-download'></button>
              </form>";
            }
        echo"</td>
          <td>
