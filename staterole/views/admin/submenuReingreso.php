...
<div class="cuadro" style="padding: 150px;">
  ...
  <div class="container" style="background-color: #fff">
      ...
      <form action="registroReingreso.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Registrar Reingreso</button>
      </div>
      </form>
      <form action="listadoReingreso.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Consultar Reingresos</button>
      </div>
      </form>
