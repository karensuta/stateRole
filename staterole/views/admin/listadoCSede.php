...
<header>
  <div class="container"><h1 style="color: #fff;">Lista de Cambios de Sede</h1></div>
</header>
<?php 
    ...
    <table width="100%" border="0">
      ...
      foreach ($res as $x) {
        ...
        <tr>
          ...
          <td>".$x["observacion"]."</td>
          <td>
            <form action='actualizarCSede.php' method='post'>
          ...
          <td>
            <form action='../../negocio/eliminar/cSede.php' method='post'>
              <input type='hidden' name='id_usuario' value=".$x['id_usuario'].">
              <input type='hidden' name='id_tipo_novedad' value='5'>
