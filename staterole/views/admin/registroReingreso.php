...
<header>
  <div class="container"><h1 style="color: #fff;">Registro de Reingreso</h1></div>
</header>
<?php 
...
<div class="cuadro" style="padding: 80px;">
  ...
  <div class="container table-responsive" style="background-color: #fff">
      ...
      <h1>Registar Reingreso</h1>
      
      <form action="reingreso.php" method="post" class="form-horizontal">
        <div class="col-md-12 mb-12">
          ...
          <div class="form-group">
            <button class="btn btn-dark form-control" type="submit">Registrar Reingreso</button>
          </div>
      </form>
          <div class="form-group">
            <form action="submenuReingreso.php"><button class="btn btn-dark form-control" type="submit">Volver</button></form>
          </div>
        </div>
  </div>
