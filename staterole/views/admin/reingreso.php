...
<div class="cuadro table-responsive">
  ...
  foreach ($res as $x) {
    echo "
    <form action='../../negocio/registro/reingreso.php' method='post' class='form-horizontal'>
      <div class='form-row'>
        ...
        <div class='col-md-10'>
          <textarea class='form-control text-center' name='observacion' placeholder='Escriba sus observaciones' required</></textarea>
        </div>
      ...
      <div class=form-row>
        ...
        <div class=col-md-6>
        <form action='registroReingreso.php'><button class='btn btn-danger form-control' type='submit'>volver</button></form>
        </div>
      </div>
