...
<header>
  <div class="container"><h1 style="color: #fff;">Registro de Aplazamiento</h1></div>
</header>
<?php 
...
<div class="cuadro" style="padding: 80px;">
  ...
  <div class="container table-responsive" style="background-color: #fff">
      ...
      <h1>Registar Aplazamiento</h1>
      
      <form action="aplazamiento.php" method="post" class="form-horizontal">
        <div class="col-md-12 mb-12">
          ...
          <div class="form-group">
            <button class="btn btn-dark form-control" type="submit">Registrar Aplazamiento</button>
          </div>
      </form>
          <div class="form-group">
            <form action="submenuAplazamiento.php"><button class="btn btn-dark form-control" type="submit">Volver</button></form>
          </div>
        </div>
  </div>
