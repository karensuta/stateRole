...
<header>
    <div class="container">
      <h1>ACTUALIZAR CAMBIO DE JORNADA</h1>
    </div>
  </header>
<br><br><br><br>
<div class="cuadro">
  ...
  foreach ($ac as $z) {
    echo "
      ...
      <form action='../../negocio/actualizar/cJornada.php' method='post'>
      ...
      <div class=form-row>
        ...
        <div class=col-md-6>
          <form action='listadoCJornada.php'><button class='btn btn-danger form-control' type='submit'>volver</button></form>
        </div>
      </div>
