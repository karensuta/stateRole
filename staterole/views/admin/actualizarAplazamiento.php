...
<div class="cuadro">
  ...
  foreach ($ac as $z) {
    echo "
      ...
      <form action='../../negocio/actualizar/aplazamiento.php' method='post'>
      ...
      <div class=form-row>
        ...
        <div class=col-md-6>
          <form action='listadoAplazamiento.php'><button class='btn btn-danger form-control' type='submit'>volver</button></form>
        </div>
      </div>
