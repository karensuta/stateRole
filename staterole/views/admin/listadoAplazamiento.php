...
<header>
  <div class="container"><h1 style="color: #fff;">Lista de Aplazamiento</h1></div>
</header>
<?php 
    ...
    <table width="100%" border="0">
      ...
      foreach ($res as $x) {
        ...
        <tr>
          ...
          <td>".$x["observacion"]."</td>
          <td>
            <form action='actualizarAplazamiento.php' method='post'>
          ...
          <td>
            <form action='../../negocio/eliminar/aplazamiento.php' method='post'>
              <input type='hidden' name='id_usuario' value=".$x['id_usuario'].">
              <input type='hidden' name='id_tipo_novedad' value='2'>
      ...
      <table width="100%">
        <tr>
          <form action="submenuAplazamiento.php">
