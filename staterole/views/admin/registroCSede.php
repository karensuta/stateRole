...
<header>
  <div class="container"><h1 style="color: #fff;">Registrar Cambio de Sede</h1></div>
</header>
<?php 
...
<div class="cuadro" style="padding: 80px;">
  ...
  <div class="container" style="background-color: #fff">
      ...
      <h1>Registar Cambio de Sede</h1>
      
      <form action="cSede.php" method="post" class="form-horizontal">
        <div class="col-md-12 mb-12">
          ...
          <div class="form-group">
            <button class="btn btn-dark form-control" type="submit">Registrar Cambio de Sede</button>
          </div>
      </form>
          <div class="form-group">
