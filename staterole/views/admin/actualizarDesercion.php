...
<div class="cuadro">
  ...
  foreach ($ac as $z) {
    echo "
      ...
      <form action='../../negocio/actualizar/desercion.php' method='post'>
      ...
      <div class=form-row>
        ...
        <div class=col-md-6>
          <form action='listadoDesercion.php'><button class='btn btn-danger form-control' type='submit'>volver</button></form>
        </div>
      </div>
