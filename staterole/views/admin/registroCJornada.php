...
<header>
  <div class="container"><h1 style="color: #fff;">Registrar Cambio de Jornada</h1></div>
</header>
<?php 
...
<div class="cuadro" style="padding: 80px;">
  ...
  <div class="container" style="background-color: #fff">
      ...
      <h1>Registar Cambio de Jornada</h1>
      
      <form action="cJornada.php" method="post" class="form-horizontal">
        <div class="col-md-12 mb-12">
          ...
          <div class="form-group">
            <button class="btn btn-dark form-control" type="submit">Registrar Cambio de Jornada</button>
          </div>
      </form>
          <div class="form-group">
            <form action="submenuTraslado.php"><button class="btn btn-dark form-control" type="submit">Volver</button></form>
          </div>
        </div>
  </div>
