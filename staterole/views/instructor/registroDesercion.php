...
<header>
  <div class="container"><h1 style="color: #fff;">Registrar de Deserciones</h1></div>
</header>
<?php 
...
<div class="cuadro" style="padding: 80px;">
  ...
  <div class="container" style="background-color: #fff">
      ...
      <h1>Registar Deserción</h1>
      
      <form action="desercion.php" method="post" class="form-horizontal">
        <div class="col-md-12 mb-12">
          ...
          <div class="form-group">
            <button class="btn btn-dark form-control" type="submit">Registrar Deserción</button>
          </div>
      </form>
          <div class="form-group">
            <form action="submenuDesercion.php"><button class="btn btn-dark form-control" type="submit">Volver</button></form>
          </div>
        </div>
  </div>
