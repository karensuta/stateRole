  ...
  <div class="container table-responsive" style="background-color: #fff; padding: 100px; ">
    ...
    <table width="100%" border="0">
      ...
      echo "</select>
          ...
          <tr>
            ...
            <td>
              ...
              $cxn=Conexion::conectar();
              $sec=$cxn->query("SELECT * FROM ficha inner join formacion on ficha.id_formacion=formacion.id_formacion WHERE ficha.estado_ficha=1");
      ...
      <table width="100%">
        <tr>
          <td>
            <?php echo "<input type='hidden' name='volver' value='$_POST[volver]'>"; ?>
          ...
          <td>
            ...
            if($_POST["volver"]==0){
              echo "<form action='informacionUsuario.php'><button class='btn form-control'>Volver</button></form>";
            }else{
              echo "<form action='listadoAprendiz.php'><button class='btn form-control'>Volver</button></form>";
            }
