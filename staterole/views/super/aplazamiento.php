...
<div class="cuadro table-responsive">
  ...
  foreach ($res as $x) {
    echo "
    <form action='../../negocio/registro/aplazamiento.php' method='post' class='form-horizontal'>
      <div class='form-row'>
        ...
        <div class='col-md-10'>
          <textarea class='form-control text-center' name='observacion' placeholder='Escriba el porque desea hacer el aplazamiento' required</></textarea>
        </div>
      ...
      <div class=form-row>
        <div class=col-md-6>
          ...
          <input type='hidden' name='id_tipo_novedad' value='2'>
          <button class='btn btn-primary form-control' type='submit'>Registrar</button>
    </form>
        </div>
        <div class=col-md-6>
        <form action='registroAplazamiento.php'><button class='btn btn-danger form-control' type='submit'>volver</button></form>
        </div>
      </div>
