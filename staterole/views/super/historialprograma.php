...
<header>
  <div class="container"><h1 style="color: #fff;">Historial de los Programas de Formación en el Sistema</h1></div>
</header>
    ...
    <table width="100%" border="0">
      ...
      foreach ($res as $x) {
        ...
        <tr>
          ...
          <td>";
          if ($x["tipo_programa"]==1) {
            echo "Técnico";
          }
          if ($x["tipo_programa"]==2) {
            echo "Tecnólogo";
          }
          if ($x["tipo_programa"]==3) {
