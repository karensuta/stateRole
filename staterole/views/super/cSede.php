...
<div class="cuadro table-responsive">
  ...
  foreach ($res as $x) {
    echo "
    <form action='../../negocio/registro/cSede.php' method='post' class='form-horizontal'>
      <div class='form-row'>
        ...
        <div class='col-md-10'>
          <p align=center><strong>Recuerde!</strong> Las Sedes disponibles son: Alamos, Barrio Colombia, Complejo Sur, Restrepo y Ricaurte.</p>
          <textarea class='form-control text-center' name='observacion' placeholder='Escriba a cual Sede y el porque desea hacer el cambio.' required</></textarea>
        </div>
      ...
      <div class=form-row>
        <div class=col-md-6>
          ...
          <input type='hidden' name='id_tipo_novedad' value='5'>
          <button class='btn btn-primary form-control' type='submit'>Registrar</button>
    </form>
        </div>
        <div class=col-md-6>
        <form action='registroCSede.php'><button class='btn btn-danger form-control' type='submit'>volver</button></form>
        </div>
      </div>
