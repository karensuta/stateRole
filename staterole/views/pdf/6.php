<?php
        ...
        $pdf->setFont('Arial','',10);
        $pdf->Cell(140, 8, utf8_decode('Revisión de la solicitud de traslado de ficha del aprendiz anteriormente mencionado.'),0,'l',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->Cell(93, 8, 'El aprendiz radica solicitud de traslado de ficha',0,1,'l',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->multiCell(150, 8, utf8_decode('Se realiza la revisión de solicitud de traslado de ficha, de acuerdo a los resultados emitidos.'),0,'D',0);
        ...
        $pdf->multicell(48, 8, $x['observacion'],1,'J' );
