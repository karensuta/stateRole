<?php
        ...
        $pdf->setFont('Arial','',10);
        $pdf->Cell(140, 8, utf8_decode( 'Revisión de la solicitud de Retiro Voluntario del aprendiz anteriormente mencionado.'),0,'l',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->Cell(93, 8, utf8_decode('El aprendiz envía correo electrónico, radica el formato y/o carta de retiro voluntario del programa de formación '),0,1,'l',0);

        /*Descargos*/
        $pdf->SetY(156);
        $pdf->SetX(10);
        $pdf->setFont('Arial','B',12);
        $pdf->cell(18, 8, 'Descargos de aprendiz (ces):',0,0,'l' );
        $pdf->setFont('Arial','',10);
        $pdf->SetY(166);
        $pdf->SetX(10);
        $pdf->multiCell(190, 8, utf8_decode('El aprendiz envía correo electrónico, entrega formato y/o carta de retiro voluntario del programa de formación '),0,'D',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->multiCell(180, 6, utf8_decode('Envía correo electrónico, Formato y/o carta de retiro voluntario diligenciado y firmado por el aprendiz.'),0,'J',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->multiCell(180, 6, utf8_decode('Se acepta el Retiro Voluntario del aprendiz anteriormente mencionado.'),0,'J',0);
        ...
        $pdf->output("Acta_Retiro_Voluntario.pdf","D");
