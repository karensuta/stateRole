<?php
        ...
        $pdf->setFont('Arial','',10);
        $pdf->Cell(140, 8, utf8_decode( 'Revisión de la solicitud de Aplazamiento del aprendiz anteriormente mencionado.'),0,'l',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->Cell(93, 8, utf8_decode('El aprendiz radica la solicitud de Aplazamiento del programa de formación '),0,1,'l',0);
        ...
        $pdf->SetY(166);
        $pdf->SetX(10);
        $pdf->multiCell(190, 8, utf8_decode('El aprendiz entrega la solicitud de Aplazamiento del programa de formación. '),0,'D',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->multiCell(180, 6, utf8_decode('solicitud de Aplazamiento diligenciado y firmado por el aprendiz.'),0,'J',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->multiCell(180, 6, utf8_decode('Se acepta el Aplazamiento del aprendiz anteriormente mencionado por Calamidad Domestica'),0,'J',0);
        ...
        $pdf->output("Acta_Aplazamiento.pdf","D");
