<?php
        ...
        $pdf->setFont('Arial','',12);
        $pdf->cell(18, 8, date('d/m/y'),0,0,'l' );
        $pdf->setFont('Arial','B',12);
        $pdf->cell(14, 8, 'Ficha:',0,0,'l' );
        $pdf->setFont('Arial','',12);
        $pdf->cell(23, 8, $x['ficha'],0,0,'l' );
        $pdf->setFont('Arial','B',12);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->Cell(140, 8, utf8_decode('Revisión de la solicitud de traslado de Centro del aprendiz anteriormente mencionado.'),0,'l',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->Cell(93, 8, 'El aprendiz radica solicitud de traslado de Sede',0,1,'l',0);
        ...
        $pdf->setFont('Arial','',10);
        $pdf->multiCell(150, 8, utf8_decode('Se realiza la revisión de solicitud de traslado de Centro, de acuerdo a los resultados emitidos.'),0,'D',0);
        ...
        $pdf->cell(22, 8,utf8_decode('Comentarios de los miembros de comité:'),0,1,'L');
        $pdf->setFont('Arial','',10);
        $pdf->multiCell(199, 8, utf8_decode('Se realiza la revisión en el aplicativo Sena Sofía para validar las competencias y resultados de aprendizaje correspondientes de acuerdo a la formación del aprendiz para darle traslado a la ficha que este en paralelo y que cumpla con las mismas características de código de Programa, versión, cupo y tipo de oferta. Luego de la validación se le genera la novedad de Traslado de Sede en el aplicativo Sena Sofía'),0,'D',0);
        ...
        $pdf->SetY(43);
        $pdf->SetX(10);
        $pdf->cell(33, 8, utf8_decode('Recomendaciones del comité:'),0,1,'l' );
        /* Muestra lo primero del cuadro*/
        $pdf->setFont('Arial','B',10);
        $pdf->SetY(55);
        $pdf->SetX(10);
        ...
        $pdf->multicell(48, 4, $x['observacion'],1,'J' );
        ...
        $pdf->output("Acta_Cambio_de_sede.pdf","D");
?>