...
<body>
	<script type="text/javascript">alert("Las contarseñas no coinciden vuelva a realizar el registro");</script>
	<a href="inicio.php"></a>
		...
		<div class="formulario">
			...
			<form action="../../controlador/datos_registro.php" method="post">
				...
				<select name="tipo_documento" class="elect">
					<option value="T.I">Tarje de Identidad</option>
					<option value="C.C">Cedula Ciudadania</option>
					<option value="C.E">Cedula Extrangeria</option>
				</select><br>
				<input type="text" placeholder="Documento" name="documento" required>
				<input type="email" placeholder="Correo" name="correo" placeholder>
				<input type="password" placeholder="Contraseña" name="contrasena" required>
