...
<div class="container">
  <form action="../administrador/mostrar/consultaCC.php" method="post" class="form-horizontal">
    ...
    <form action="../../vista/administrador/submenuTraslados.php" method="post" class="form-horizontal">
      <div class="form-group">
