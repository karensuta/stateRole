...
<div class="cuadro">
	...
	<form action="../../../controlador/registro/datos_desercion.php" method="post" class="form-horizontal">
  <div class="form-row">
    ...
    <div class="col-md-12 mb-12">
      <label for="validationServer01">Observaciones:</label><textarea class="form-control" name="observaciones" placeholder="Escriba observaciones*" required=""></textarea>
      <div class="valid-feedback">
      </div>
      </div>
    </div>
    ...
    <button class="btn btn-dark form-control" type="submit">Guardar</button>
  </form>
  <br>
