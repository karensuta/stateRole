...
<div class="cuadro">
	...
	<form action="../../../controlador/registro/datos_cambioJornada.php" method="post" class="form-horizontal">
  <div class="form-row">
    ...
    <div class="col-md-6 mb-6">
     ...
     <div class="col-md-6 mb-6">
      ...
      <input type="date" class="form-control" name="fecha" placeholder="AAAA-MM-DD" required>
      <div class="valid-feedback">
      </div>
    </div>
    ...
    <div class="col-md-6 mb-6">
     ...
     <div class="col-md-6 mb-6">
      <label for="validationServer01">Sede</label>
    ...
    <div class="col-md-6 mb-6">
      <label for="validationServer01">Jornada actual</label>
      <select class="custom-select" name="jornada">
     <option selecteds>Jornada actual*</option>
    ...
    <div class="col-md-6 mb-6">
      <label for="validationServer01">Jornada próxima</label>
      <select class="custom-select" name="jornada_p">
     <option selecteds>Jornada próxima*</option>
      <option value="Diurna">Diurna</option>
      <option value="Nocturna">Nocturna</option>
      <option value="Fin de semana">Fin de semana</option>
    </select>
    ...
    <div class="col-md-12 mb-12">
      <label for="validationServer01">Motivos:</label><textarea class="form-control" name="motivos" placeholder="Escriba motivos*" required=""></textarea>
      <div class="valid-feedback">
      </div>
      </div>
    </div>
    ...
    <button class="btn btn-dark form-control" type="submit">Solicitud</button>
  </form>
  <br>
