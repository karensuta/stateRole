...
<div class="cuadro">
	...
	<form action="../../../controlador/registro/datos_reingreso.php" method="post" class="form-horizontal">
  <div class="form-row">
    ...
    <div class="col-md-12 mb-12">
      <label for="validationServer01">Trimestre de reingreso</label>
      <select class="custom-select" name="trimestre">
    <option selected>Trimestre de reingreso*</option>
