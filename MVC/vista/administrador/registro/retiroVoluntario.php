...
<div class="cuadro">
	...
	<form action="../../../controlador/registro/datos_retiro.php" method="post" class="form-horizontal">
  <div class="form-row">
    ...
    <div class="col-md-12 mb-12">
      <label for="validationServer01">Causas:</label><textarea class="form-control" name="causas" placeholder="Escriba Causas*" required=""></textarea>
      <div class="valid-feedback">
      </div>
      </div>
    </div>
