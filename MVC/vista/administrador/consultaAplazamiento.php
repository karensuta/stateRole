...
<div class="container">
  <form action="../administrador/mostrar/consultaA.php" method="post" class="form-horizontal">
    ...
    <form action="../../vista/administrador/submenuAplazamiento.php" method="post" class="form-horizontal">
      <div class="form-group">
