...
<div class="container">
  <form action="../administrador/mostrar/consultaR.php" method="post" class="form-horizontal">
    ...
    <form action="../../vista/administrador/submenuReingresos.php" method="post" class="form-horizontal">
      <div class="form-group">
