...
<div class="container">
  <form action="../administrador/mostrar/consultaD.php" method="post" class="form-horizontal">
    ...
    <form action="../../vista/administrador/submenuDesercion.php" method="post" class="form-horizontal">
      <div class="form-group">
