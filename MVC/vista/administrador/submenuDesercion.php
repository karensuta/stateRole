...
<div class="cuadro">
  ...
  <div class="container" style="background-color: #fff">
      ...
      <form action="../../vista/administrador/registro/desercion.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Crear deserción</button>
      </div>
      </form>
      <form action="../../vista/administrador/consultaDesercion.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Consultar deserción</button>
      </div>
      </form>
