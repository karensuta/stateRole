...
<div class="cuadro">
  ...
  <div class="container" style="background-color: #fff">
      ...
      <form action="../../vista/administrador/registro/retiroVoluntario.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Crear retiro voluntario</button>
      </div>
      </form>

      <form action="../../vista/administrador/consultaRetiroVoluntario.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Consultar retiro voluntario</button>
      </div>
      </form>

      <form action="../../vista/inicio.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-danger form-control" type="submit">Volver</button>
      </div>
      </form>
  </div>
