...
<header>
  ...
  <br><br><br><br>
    ...
    $actulaizarRV = $consulta -> mostrarRetiroV($_POST["documento"]);

    foreach ($actulaizarRV as $key) {
      
      echo "<form action=\"../../../controlador/actualizar/retiroA.php\" method=\"post\">
      <table width=\"1000\" border=\"0\" align=\"center\">
          <tbody>
            ...
            <tr>
              <td>Causas:</td>
              <td>$key[causas]</td>
              <td><input type=\"text\" class=\"form-control\" name=\"causas_nuevo\" value=\"$key[causas]\" required></td>
            </tr>
            <tr>
              <td colspan=\"3\"><br></td>
            </tr>
