...
<br>  
  ...
  $actualizarDa = $consultar -> mostrarDatos($_POST["documento"]);

  foreach ($actualizarDa as $key) {

    echo "<form action=\"../../../controlador/actualizar/datosA.php\" method=\"post\">
    <table  border=\"0\" align=\"center\">
    <tbody>
    <tr>
      <td width=\"400\">Nombre:</td>
      <td width=\"400\">$key[nombre]</td>
      <td width=\"400\"><input type=\"text\" class=\"form-control\" name=\"nombre_nuevo\" value=\"$key[nombre]\" required></td>
    </tr>
    <tr>
      <td width=\"400\">Apellido:</td>
      <td width=\"400\">$key[apellido]</td>
      <td width=\"400\"><input type=\"text\" class=\"form-control\" name=\"apellido_nuevo\" value=\"$key[apellido]\" required></td>
    </tr>
    <tr>
      <td width=\"400\">Tipo de documento:</td>
      <td width=\"400\">$key[tipo_documento]</td>
      <td width=\"400\">
    ...
    <tr>
      ...
      <td width=\"400\">$key[documento]</td>
      <td width=\"400\">$key[documento]</td><input type=\"hidden\" name=\"documento\" value=\"$key[documento]\">
    </tr>
    <tr>
      <td width=\"400\">Correo electrónico:</td>
      <td width=\"400\">$key[correo]</td>
      <td width=\"400\"><input type=\"text\" class=\"form-control\" name=\"correo_nuevo\" value=\"$key[correo]\" required></td>
    </tr>
    <tr>
      <td width=\"400\">Rol:</td>
      <td width=\"400\">$key[rol]</td>
      <td width=\"400\">
        <select class=\"custom-select\" name=\"rol_nuevo\">
          <option selecteds>$key[rol]</option>
    ...
    <div class=\"form-row\">
      <td width=\"500\">
        <div class=\"col-md-12 mb-12\">
         <input class=\"btn btn-info form-control\" type=\"submit\" value=\"Guardar\">
</form> 
        </div>
      </td>
      <td width=\"500\">
        <div class=\"col-md-12 mb-12\">
          <form action=\"../inicio.php\"><button class=\"btn btn-danger form-control\" type=\"submit\">Cancelar</button></form>
        </div> 
      </td> 
    </div> 
  </tr>
