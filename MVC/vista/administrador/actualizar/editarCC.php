...
<header>
  ...
  <br><br><br><br>
    ...
    foreach ($cambioc as $key) {
      ...
      echo "<form action=\"../../../controlador/actualizar/cambioCentroA.php\" method=\"post\">
      <table width=\"1000\" border=\"2\" align=\"center\">
          <tbody>
            ...
            <tr>
             ...
             <tr>
              <td>Sede de traslado:</td>
              <td>$key[sede_t]</td>
              <td>
              <select class=\"custom-select\" name=\"sede_t_nuevo\">
                <option selected>$key[sede_t]</option>
            ...
            <tr>
              ...
              <td><input type=\"text\" class=\"form-control\" name=\"descripcion_nuevo\" value=\"$key[descripcion]\" required></td>
            </tr>
            <tr>
              <td colspan=\"3\"><br></td>
            </tr>
