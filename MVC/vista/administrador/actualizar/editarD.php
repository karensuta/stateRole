...
<header>
  ...
  <br><br><br><br>
    ...
    $actulaizarD = $consulta -> mostrarDesercion($_POST["documento"]);

    foreach ($actulaizarD as $key) {
      
      echo "<form action=\"../../../controlador/actualizar/desercionA.php\" method=\"post\">
      <table width=\"1000\" border=\"0\" align=\"center\">
          <tbody>
            ...
            <tr>
              ...
              <td><input type=\"text\" class=\"form-control\" name=\"observaciones_nuevo\" value=\"$key[observaciones]\" required></td>
            </tr>
            <tr>
              <td colspan=\"3\"><br></td>
            </tr>
