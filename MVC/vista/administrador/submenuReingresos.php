...
<div class="cuadro">
  ...
  <div class="container" style="background-color: #fff">
      ...
      <form action="../../vista/administrador/registro/reingreso.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Crear reingreso</button>
      </div>
      </form>

      <form action="../../vista/administrador/consultaReingresos.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Consultar reingreso</button>
      </div>
      </form>
