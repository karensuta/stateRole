...
<div class="cuadro">
  ...
  <div class="container" style="background-color: #fff">
      ...
      <form action="../../vista/administrador/registro/aplazamiento.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Crear aplazamiento</button>
      </div>
      </form>

      <form action="../../vista/administrador/consultaAplazamiento.php" method="post" class="form-horizontal">
      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Consultar aplazamiento</button>
      </div>
      </form>
