...
<header style="background-color: #000; width: 100%; text-align: center; font-family: Montserrat; height: 170px;">
  <div class="container"><h1>CONSULTAR</h1></div>
</header>
<br><br><br>

<div class="container">
  <form action="../administrador/mostrar/consultaRV.php" method="post" class="form-horizontal">
  
    <div class="col-md-12 mb-12">
      <div class="form-group">
        <label for="validationServer01" class="titulo">Número de documento</label>
        <input type="text" class="form-control" name="documento" placeholder="Documento*" required>
      </div>
    </div>

      <div class="form-group">
        <button class="btn btn-dark form-control" type="submit">Consultar</button>
      </div>
    </form>  
  
    <form action="../../vista/administrador/submenuRetiroVoluntario.php" method="post" class="form-horizontal">
      <div class="form-group">
